...
export const metadata: Metadata = {
  title: "Bảng Giá Cửa Nhôm Kính Cần Thơ 2025 — Nhôm Việt, Nhập, Maxpro",
  description:
    "Bảng giá cửa nhôm kính Cần Thơ 2025 — nhôm Việt, nhôm nhập, Maxpro hệ 55/65/83, cửa kính bản lề sàn, lan can cầu thang. Chưa VAT. Gọi: 0945 042 345.",
  alternates: { canonical: `${siteUrl}/bang-gia-cua-nhom-kinh-can-tho` },
  openGraph: {
    type: "website",
    locale: "vi_VN",
    url: `${siteUrl}/bang-gia-cua-nhom-kinh-can-tho`,
    title: "Bảng Giá Cửa Nhôm Kính Cần Thơ 2025",
